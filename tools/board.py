...
LIVE_RESULTS = {
    ...
    16: dict(thru=12, up=-3),  # Hugo v Collie -- Collie 3 up thru 12 (Collie's shot halved the 7th, won the 12th)
...
LIVE_SF = {
    ...
    'Mully':             dict(thru=14, pts=20),
    'Hugo':              dict(thru=12, pts=10),
    'Collie':            dict(thru=12, pts=12),
