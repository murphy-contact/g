...
LIVE_RESULTS = {
    9:  dict(thru=12, up=-1),  # Govy v Johnny McCafferty -- Johnny 1 up thru 12 (Govy scratched 10th; Johnny's shot won the 12th)
...
LIVE_SF = {
    'Govy':              dict(thru=12, pts=19),   # scratched 10th
    'Johnny McCafferty': dict(thru=12, pts=20),   # scratched 1st, 5th
    'Fintan Flynn':      dict(thru=12, pts=21),
    'Ray McCarron':      dict(thru=12, pts=18),   # scratched 5th, 6th
    'Frank':             dict(thru=10, pts=23),
    'Marty':             dict(thru=10, pts=16),
    'Ronnie Flanagan':   dict(thru=12, pts=8),   # scratched 1-3, 6, 8, 9
    'Seamus McKiernan':  dict(thru=12, pts=25),
    ...
    'Jamie Teague':      dict(thru=6, pts=5),
    'Ingy':              dict(thru=6, pts=9),
    ...
    'Collie':            dict(thru=10, pts=11),
    'Rusty':             dict(thru=12, pts=12),
    'Sean Conlon':       dict(thru=12, pts=13),
    'Ben Caughey':       dict(thru=12, pts=29),
    'Andy':              dict(thru=12, pts=16),
}
