...
LIVE_RESULTS = {
    ...
    20: dict(thru=9, up=-1),   # Johnny McManus v Goof -- Goof 1 up thru 9
...
LIVE_SF = {
    ...
    'Johnny McManus':    dict(thru=9, pts=6),
    'Goof':              dict(thru=9, pts=11),
    ...
    'Jamie McCaffrey':   dict(thru=16, pts=23),
    'Blobby':            dict(thru=16, pts=22),
